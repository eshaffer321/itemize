...
const styles = {
  base: [
    ...
    // Focus
    'focus:not-data-focus:outline-hidden data-focus:outline-2 data-focus:outline-offset-2 data-focus:outline-brand-500',
    // Disabled
  ...
  colors: {
    ...
    brand: [
      ...
      '[--btn-icon:var(--color-brand-300)] data-active:[--btn-icon:var(--color-brand-200)] data-hover:[--btn-icon:var(--color-brand-200)]',
    ],
  },
}
